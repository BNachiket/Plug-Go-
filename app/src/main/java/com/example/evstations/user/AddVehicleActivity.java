...
//        vehnumber = etxtNumber.getText().toString();
        vehnumber = etxtNumber.getText().toString().toUpperCase(); // convert to uppercase

        if (!vehnumber.matches("^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$")) {
            etxtNumber.setError("Invalid format (e.g. MH01AB1234)");
